  ...
  function BottomSheet(props, ref) {
    ...
    const getEvaluatedPosition = useWorkletCallback(
      function getEvaluatedPosition(source: ANIMATION_SOURCE) {
         ...
         */
        const resolveSnapPointByIndex = (targetIndex: number) => {
          'worklet';
          const isValidIndex =
            targetIndex >= 0 && targetIndex < snapPoints.length;
        ...
        const isCurrentlyClosed =
          Math.abs(animatedPosition.value - animatedClosedPosition.value) <= 0.5;
